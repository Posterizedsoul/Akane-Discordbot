...
#Thanks to Carberrata's Discord.py tutorial for this cog.
...
class Music(commands.Cog, wavelink.WavelinkMixin):
    ...
    @commands.command(name="connect", aliases=["join",'cum'])
    ...
    async def lyrics_command(self, ctx, *,name: t.Optional[str]):
        ...
        genius = lyricsgenius.Genius('PXEIzSPCsCisjN7FT6dF7LWKPCV9WKS_TdDho7QSZrZnKT1aiAEr5RA7sZ1lws9P')
    ...
    @commands.command(name="playing", aliases=["np", 'now'])
